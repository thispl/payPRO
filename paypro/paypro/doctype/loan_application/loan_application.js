...
frappe.ui.form.on('Loan Application', {
	...
	create_loan: function(frm) {
		...
		frappe.model.open_mapped_doc({
			method: 'paypro.paypro.doctype.loan_application.loan_application.create_loan',
			frm: frm
		});
	},
	create_loan_security_pledge: function(frm) {
		frappe.call({
			method: "paypro.paypro.doctype.loan_application.loan_application.create_pledge",
			args: {
