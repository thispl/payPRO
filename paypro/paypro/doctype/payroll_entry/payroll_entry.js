...
frappe.ui.form.on('Payroll Entry', {
	...
	add_bank_entry_button: function(frm) {
		frappe.call({
			method: 'paypro.paypro.doctype.payroll_entry.payroll_entry.payroll_entry_has_bank_entries',
			args: {
				'name': frm.doc.name
			},
			callback: function(r) {
	...
	set_start_end_dates: function (frm) {
		if (!frm.doc.salary_slip_based_on_timesheet) {
			frappe.call({
				method: 'paypro.paypro.doctype.payroll_entry.payroll_entry.get_start_end_dates',
				args: {
	...
	set_end_date: function(frm){
		frappe.call({
			method: 'paypro.paypro.doctype.payroll_entry.payroll_entry.get_end_date',
			args: {
