...
frappe.ui.form.on('Salary Structure', {
	...
	preview_salary_slip: function(frm) {
		frappe.call({
			method: "paypro.paypro.doctype.salary_structure.salary_structure.get_employees",
			args: {
	...
	open_salary_slip: function(frm, employee){
		...
		frappe.call({
			method: "paypro.paypro.doctype.salary_structure.salary_structure.make_salary_slip",
			args: {
