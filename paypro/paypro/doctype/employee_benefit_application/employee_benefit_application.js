...
frappe.ui.form.on('Employee Benefit Application', {
	employee: function(frm) {
		...
		if(frm.doc.employee && frm.doc.date && frm.doc.payroll_period){
			method = "paypro.paypro.doctype.employee_benefit_application.employee_benefit_application.get_max_benefits_remaining";
			args = {
			...
			method = "paypro.paypro.doctype.employee_benefit_application.employee_benefit_application.get_max_benefits";
			args = {
				employee: frm.doc.employee,
				on_date: frm.doc.date
			};
